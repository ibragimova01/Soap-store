      ...
      return (
        <div className="container">
          <div className="row d-none d-md-flex">
            ...
            <div className="col-2 h3">Цена</div>
            <div className="col-2 h3">Кол-во</div>
            <div className="col-3 h3">Сумма</div>
          </div>
          ...
          <div className="row justify-content-end mt-5 py-5">
            <div
              ...
              style={background}
            >
              <div className="col-6 m-0 h6 font-weight-bold">Итого</div>
            ...
            <div className="col-12 col-sm-8 col-md-5 col-lg-4 p-0 mt-1">
              <button
                ...
                className="btn btn-danger border-0 w-100 text-light"
              >
...
const mapDispatchToProps = { addProduct, addOrder };
