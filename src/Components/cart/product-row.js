...
class CartProductRow extends Component {
  ...
  render() {
    ...
    return (
      <div key={product.id} className="row border-top border-bottom py-3 align-items-center">
                  ...
                  <div className="col-2 col-md-2 my-3 my-md-0 col-lg-2 order-2">
                      <p className=" m-0"><span className="d-inline-block d-md-none">Цена:&nbsp;</span>{ product.price } сом</p>
                  </div>
